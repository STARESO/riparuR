...
macrodechets_essential <- readRDS(paths$macrodechets_essential_processed)
...
fviz_nbclust(rep_pca$x[, c(1:3)], FUNcluster = kmeans, k.max = 10) # 2 clusters
fviz_nbclust(rep_pca$x[, c(1:3)], FUNcluster = kmeans, k.max = 10, method = "wss") # 2 clusters


## PCA plotting ----
nice_pca_plot(rep_pca, axes = c(1, 2), nb_axes = 3, cluster_number = 2,  contrib = 7) %>%
  ggsave(filename = "figures/pca/rep/pca_filiere_rep_axes12.png",
         width = 2000,
         height = 1080,
         scale = 4,
         units = "px",
...
nice_pca_plot(rep_pca, axes = c(1, 3), nb_axes = 3, cluster_number = 2,  contrib = 7) %>%
  ggsave(filename = "figures/pca/rep/pca_filiere_rep_axes13.png",
         width = 2000,
         height = 1080,
         scale = 4,
         units = "px",
...
nice_pca_plot(rep_pca, axes = c(2, 3), nb_axes = 3, cluster_number = 2,  contrib = 7) %>%
  ggsave(filename = "figures/pca/rep/pca_filiere_rep_axes23.png",
         width = 2000,
         height = 1080,
         scale = 4,
         units = "px",
...
effet_group_biplots(rep_pca, macrodechets_rep_habillage, contrib = 7) %>%
  ggsave(filename = "figures/pca/rep/pca_filiere_rep_groups.png",
         width = 4000,
         height = 1000,
         scale = 3,
         units = "px",
...
effet_group_biplots(rep_pca, macrodechets_rep_habillage, addEllipses = FALSE, contrib = 7) %>%
  ggsave(filename = "figures/pca/rep/pca_filiere_rep_groups_no_ellipses.png",
         width = 4000,
         height = 1000,
         scale = 3,
         units = "px",
...
nice_pca_plot(secteurs_pca, axes = c(1, 2), nb_axes = 2, cluster_number = 3) %>%
  ggsave(filename = "figures/pca/secteurs/pca_secteurs_axes12.png",
         width = 2000,
         height = 1080,
         scale = 4,
         units = "px",
...
effet_group_biplots(secteurs_pca, macrodechets_secteurs_habillage, contrib = 20) %>%
  ggsave(filename = "figures/pca/secteurs/pca_secteurs_groups.png",
         width = 4000,
         height = 1000,
         scale = 3,
         units = "px",
...
effet_group_biplots(secteurs_pca, macrodechets_secteurs_habillage, addEllipses = FALSE, contrib = 20) %>%
  ggsave(filename = "figures/pca/secteurs/pca_secteurs_groups_no_ellipses.png",
         width = 4000,
         height = 1000,
         scale = 3,
         units = "px",
...
nice_pca_plot(DCSMM_pca, axes = c(1, 2), nb_axes = 3, cluster_number = 3, contrib = 20) %>%
  ggsave(filename = "figures/pca/DCSMM/pca_DCSMM_axes12.png",
         width = 2000,
         height = 1080,
         scale = 4,
         units = "px",
...
nice_pca_plot(DCSMM_pca, axes = c(1, 3), nb_axes = 3, cluster_number = 3, contrib = 20) %>%
  ggsave(filename = "figures/pca/DCSMM/pca_DCSMM_axes13.png",
         width = 2000,
         height = 1080,
         scale = 4,
         units = "px",
...
nice_pca_plot(DCSMM_pca, axes = c(2, 3), nb_axes = 3, cluster_number = 3, contrib = 20) %>%
  ggsave(filename = "figures/pca/DCSMM/pca_DCSMM_axes23.png",
         width = 2000,
         height = 1080,
         scale = 4,
         units = "px",
...
effet_group_biplots(DCSMM_pca, macrodechets_DCSMM_habillage, contrib = 20) %>%
  ggsave(filename = "figures/pca/DCSMM/pca_DCSMM_groups.png",
         width = 4000,
         height = 1000,
         scale = 3,
         units = "px",
...
effet_group_biplots(DCSMM_pca, macrodechets_DCSMM_habillage, addEllipses = FALSE, contrib = 20) %>%
  ggsave(filename = "figures/pca/DCSMM/pca_DCSMM_groups_no_ellipses.png",
         width = 4000,
         height = 1000,
         scale = 3,
         units = "px",
...
# PCA groupe ----
macrodechets_groupe <- macrodechets_selection(macrodechets_counts, "groupe")
...
nice_pca_plot(groupe_pca, axes = c(1, 2), nb_axes = 3, cluster_number = 3, contrib = 20) %>%
  ggsave(filename = "figures/pca/groupe/pca_groupe_axes12.png",
         width = 2000,
         height = 1080,
         scale = 4,
         units = "px",
...
nice_pca_plot(groupe_pca, axes = c(1, 3), nb_axes = 3, cluster_number = 3, contrib = 20) %>%
  ggsave(filename = "figures/pca/groupe/pca_groupe_axes13.png",
         width = 2000,
         height = 1080,
         scale = 4,
         units = "px",
...
nice_pca_plot(groupe_pca, axes = c(2, 3), nb_axes = 3, cluster_number = 3, contrib = 20) %>%
  ggsave(filename = "figures/pca/groupe/pca_groupe_axes23.png",
         width = 2000,
         height = 1080,
         scale = 4,
         units = "px",
...
effet_group_biplots(groupe_pca, macrodechets_groupe_habillage, contrib = 20) %>%
  ggsave(filename = "figures/pca/groupe/pca_groupe_groups.png",
         width = 4000,
         height = 1000,
         scale = 3,
         units = "px",
...
effet_group_biplots(groupe_pca, macrodechets_groupe_habillage, addEllipses = FALSE, contrib = 20) %>%
  ggsave(filename = "figures/pca/groupe/pca_groupe_groups_no_ellipses.png",
         width = 4000,
         height = 1000,
         scale = 3,
         units = "px",
...
nice_pca_plot(marque_pca, axes = c(1, 2), nb_axes = 3, cluster_number = 4, contrib = 20) %>%
  ggsave(filename = "figures/pca/marque/pca_marque_axes12.png",
         width = 2000,
         height = 1080,
         scale = 4,
         units = "px",
...
nice_pca_plot(marque_pca, axes = c(1, 3), nb_axes = 3, cluster_number = 4, contrib = 20) %>%
  ggsave(filename = "figures/pca/marque/pca_marque_axes13.png",
         width = 2000,
         height = 1080,
         scale = 4,
         units = "px",
...
nice_pca_plot(marque_pca, axes = c(2, 3), nb_axes = 3, cluster_number = 4, contrib = 20) %>%
  ggsave(filename = "figures/pca/marque/pca_marque_axes23.png",
         width = 2000,
         height = 1080,
         scale = 4,
         units = "px",
...
effet_group_biplots(marque_pca, macrodechets_marque_habillage, contrib = 20) %>%
  ggsave(filename = "figures/pca/marque/pca_marque_groups.png",
         width = 4000,
         height = 1000,
         scale = 3,
         units = "px",
...
effet_group_biplots(marque_pca, macrodechets_marque_habillage, addEllipses = FALSE, contrib = 20) %>%
  ggsave(filename = "figures/pca/marque/pca_marque_groups_no_ellipses.png",
         width = 4000,
         height = 1000,
         scale = 3,
         units = "px",
